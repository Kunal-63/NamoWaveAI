...
class ReelsEditor extends StatefulWidget {
  ...
  @override
  State<ReelsEditor> createState() => _ReelsEditorState();
}

class _ReelsEditorState extends State<ReelsEditor> {
  ...
  void _saveToGallery() async {
    ...
    if (result != null) {
      ...
      _hideLoading();
      _showSnackBar('Failed to save Video.');
    }
  }
  ...
  void _shareImage() async {
    ...
    // Share the GIF file
    await Share.file(
      'image.gif', // Change the file name if needed
      'image.gif', // Change the file name if needed
      bytes,
      'image/gif',
